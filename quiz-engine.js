  ...
  const MODELS = {
    ...
    hobby_synth_xlow: {
      ...
      why: [
        ...
        'Встроенные динамики - отличный вариант для дома.',
        'Автоаккомпанемент - больше возможностей и эмоций при первом знакомстве с инструментом.'
      ]
    },

    hobby_synth_low: {
      type: 'Обучающий синтезатор',
      summary: 'Хороший баланс для начинающих: ритмы, аккомпанемент и более приятная клавиатура.',
      models: [
      ...
      why: [
        ...
        'Этот тип инструмента даёт ритмы, тембры и простую навигацию.',
    ...
    hobby_synth_mid: {
      ...
      why: [
        ...
        'Ещё не студийная рабочая станция, но уже полноценные функции.'
      ]
    },
    ...
    learning_piano_compromise: {
      ...
      summary: 'В этом бюджете полноценного цифрового пианино нет — это компромисс для первых шагов. Для серьёзной техники стоит задуматься о переходе в mid-сегмент.',
      tradeoff: 'экономия сейчас vs риск возможной потери интереса',
      models: [
        { name: 'Yamaha PSR-E373', price: '32 990 ₽' },
        { name: 'Casio CT-S300', price: '18 500 ₽' }
      ],
      ...
      why: [
        'Полноценная молоточковая механика обычно немного дороже.',
        'Это временный старт для первых шагов.',
        'Лучше сразу понимать ограничения в практике игры и музицировании.'
      ],
    ...
    learning_piano_basic: {
      ...
      summary: 'Лучший вход в обучение: 88 клавиш, молоточковая механика и базовые тембры пианино.',
      tradeoff: 'баланс количества тембров и качества механики клавиш',
      models: [
      ...
      why: [
        'Для обучения важно правильное ощущение от контакта с клавиатурой.',
        'Этот класс лучше подходит для постановки техники.',
        'Полная клавиатура в 88 клавиш - полный диапазон.'
      ]
    },
    ...
    learning_piano_mid: {
      ...
      why: [
        ...
        'Лучший выбор для долгой практики.'
      ]
    },
    ...
    production_midi_mid: {
      ...
      why: [
        ...
        'Хорошо подходит для растущих задач в создании музыкальных композиций.'
      ]
    },
    ...
    stage_synth_low: {
      ...
      why: [
        ...
        'Подключение к внешнему звукоусилению здесь - норма.'
      ]
    },
    ...
    stage_synth_premium: {
      ...
      summary: 'Вы осознанно выбрали путь с минимальным набором встроенных звуков и фокусом на внешние модули семплов — рекомендуем премиум-контроллер/сценический инструмент с упором на интеграцию и управление.',
      ...
      why: [
        ...
        'Подходит для сложных комплексных решений с несколькими источниками звука.'
      ]
    },
    ...
    stage_piano_xlow: {
      ...
      tradeoff: 'фортепианная механика сейчас vs качество звука',
      models: [
        { name: 'Yamaha P-145', price: '37 000 ₽' },
        { name: 'Roland FP-10', price: '44 000 ₽' }
      ],
      ...
      upgradePath: 'Для полноценных возможностей исполнения серьезного репертуара — Roland RD-88, Yamaha CP88, Kawai MP11.'
    },
    ...
    stage_piano_low: {
      ...
      why: [
        'Молоточковая механика для пианистического репертуара на сцене.',
    ...
    allinone_universal_xlow: {
      ...
      upgradePath: 'Через год — рассматривать средний сегмент.'
    },

    allinone_universal_low: {
      type: 'Универсальный домашний инструмент',
      summary: 'Хороший вариант, если хочется один инструмент для игры, обучения и творчества.',
      models: [
      ...
      why: [
        'Один инструмент должен быть понятным и универсальным.',
        'Этот сегмент удачно подходит для домашней игры и лёгкого креатива.',
    ...
    allinone_focus_piano: {
      ...
      summary: 'С молоточковой механикой «универсальность» означает приоритет на ощущение фортепианной клавиатуры. Студийные функции, автоаккомпанемент и сценический запас здесь вторичны.',
      tradeoff: 'фортепианная техника vs сценический запас',
      models: [
        { name: 'Yamaha P-225', price: '80 000 ₽' },
        { name: 'Roland FP-30X', price: '72 000 ₽' }
      ],
      ...
      why: [
        'Вы хотите один инструмент, но именно с ощущением клавиатуры настоящего пианино.',
  ...
  function adjustBudgetByExperience(goal, experience, budget) {
    ...
    if (experience === 'beginner' && (goal === 'production' || goal === 'stage') && budget === 'high') {
      reasons.push({
        ...
        from: budget,
        to: 'mid',
        reason: 'Для начинающего в звукозаписи или сценическом сегменте high-уровень обычно избыточен.'
      });
    ...
    switch (effectiveAnswers.goal) {
      ...
      case 'learning': {
        if (effectiveAnswers.format === 'synth' && effectiveAnswers.budget === 'xlow') {
          ...
          contextWarnings.push('Для обучения фортепианной технике нужна молоточковая клавиатура. Этот синтезатор лучше подходит для базового освоения и первых шагов в изучении музыки.');
          ...
          contextWarnings.push('Для обучения игре на фортепиано автоаккомпанемент — вторичная функция. Главное: молоточковая механика и 88 клавиш. Не все цифровые пианино имеют ритмы.');
          ...
          contextWarnings.push('Встроенный базовый набор тембров — без них инструмент не сможет звучать самостоятельно.');
        } else {
          switch (effectiveAnswers.budget) {
            case 'xlow': situationKey = 'learning_piano_compromise'; break;
            case 'low':  situationKey = 'learning_piano_basic'; break;
